      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center justify-center">
            ...
            <span className="ml-2 text-gray-500 font-mono text-xs">Loading...</span>
          </div>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-white">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {isConnected && status && (
                        <span className={`text-xs font-mono ${
                          ...
                          {status === "ACTIVE" ? "Connected" : getStatusLabel(status)}
                        </span>
                      )}
                    </div>
      ...
      <Dialog open={!!disconnectDialog} onOpenChange={() => setDisconnectDialog(null)}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="font-mono text-sm">Disconnect Integration</DialogTitle>
