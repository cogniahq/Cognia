...
export const metadata: Metadata = {
  ...
  description:
    "Cognia's standard DPA, available to every customer regardless of plan. Modeled on the EU SCCs (Module 2, Controller-to-Processor) with the UK IDTA where applicable. Pre-signed; counter-sign and email back.",
    ...
    >
      <section>
        ...
        <p>
          ...
          Controller to Processor) and incorporates the UK International Data
          Transfer Addendum where applicable. It documents:
        </p>
