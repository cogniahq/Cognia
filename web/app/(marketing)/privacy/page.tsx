...
export const metadata: Metadata = {
  ...
  description:
    "What Cognia collects, how we use it, and your rights. We follow data minimization, expose self-serve export and deletion in-product, and respond to GDPR/CCPA requests within 30 days.",
