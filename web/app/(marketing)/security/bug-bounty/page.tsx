...
export const metadata: Metadata = {
  title: "Bug Bounty",
  description:
    "Responsible disclosure pays. Cognia rewards security research from $100 for low-severity findings up to $5,000 for critical issues like RCE, authentication bypass, or large-scale data exposure.",
  alternates: { canonical: "/security/bug-bounty" },
  openGraph: {
    title: "Bug Bounty · Cognia",
    description:
