...
export const metadata: Metadata = {
  title: "Security",
  description:
    "How Cognia secures your memories — TLS 1.2+ in transit, AES-256-GCM at rest for tokens and secrets, RBAC, audit logs, mandatory 2FA, and SSO via SAML or OIDC for teams.",
  alternates: { canonical: "/security" },
  openGraph: {
    title: "Security · Cognia",
    description:
