...
export const metadata: Metadata = {
  ...
  description:
    "The agreement between you and Cognia. Acceptable use, IP ownership, subscription billing through Stripe, liability cap, governing law, and dispute resolution — written in plain English.",
