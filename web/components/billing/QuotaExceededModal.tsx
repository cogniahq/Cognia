 ...
 * QuotaExceededModal
 *
 * Listens for the global `cognia:quota-exceeded` event dispatched by the
 * billing service when the API returns 402 QUOTA_EXCEEDED, and shows itself.
 * Mounted once inside `(app)/layout.tsx` so any authenticated route can
 * surface the modal without re-mounting the listener.
 */
