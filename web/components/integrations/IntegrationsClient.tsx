    ...
    <>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {available.length === 0 && !isLoading && (
          <div className="mt-8 px-4 py-8 border border-gray-200 text-center text-xs font-mono text-gray-500">
            No integrations available right now.
          </div>
        )}

        <div className="mt-6 px-3 py-2 bg-gray-50 border border-gray-200 text-xs text-gray-600">
          Need a different integration? Let us know what you&apos;d like to
          connect.
        </div>
      </div>
