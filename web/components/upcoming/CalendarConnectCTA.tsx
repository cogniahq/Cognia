 ...
 * OAuth flow in a popup; we poll connection status while the popup is
 * open and resolve when the backend reports connected=true. Lifted
 * verbatim from client/src/components/upcoming/CalendarConnectCTA.tsx.
 */
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="mt-1 text-xs text-gray-600">
            One-click &quot;Add to Calendar&quot; on any extracted upcoming
            item.
          </p>
          {error && (
